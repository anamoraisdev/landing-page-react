        ...
        <div className='container px-4 mx-auto'>
          <div className='text-center max-w-xl mx-auto'>
            ...
            <form className='mb-9'>
              ...
              <button
                className='py-4 px-6 w-full text-white font-semibold border border-black rounded-xl shadow-4xl focus:ring focus:ring-indigo-300 bg-black hover:bg-gray-700 transition ease-in-out duration-200'
                type='button'
              >
                Subscribe Now
              </button>
